...
/**
 * 隐藏状态栏和导航栏
 * 底部向上或顶部向下滑动会同时显示状态栏和导航栏，过一段时间后消失
 */
public class HideStatusAndNavigationActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_hide_status_and_navigation);
...
//            getWindow().addFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN);
    ...
    public void getNotchParams() {
        ...
        decorView.post(new Runnable() {
            @Override
            public void run() {
                System.out.println("============> bang2: " + NotchScreenUtils.hasNotchScreen(HideStatusAndNavigationActivity.this));
