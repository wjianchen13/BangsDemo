...
/**
 * 刘海屏，水滴屏工具类
 * blog: https://www.it610.com/article/1292572291309314048.htm
 */
public class NotchScreenUtils {

    private final static String TAG = NotchScreenUtils.class.getSimpleName();
    ...
    public static boolean hasNotchScreen(Activity activity){
        return isNotchAtMiui(activity)
                || hasNotchAtHuawei(activity)
                || hasNotchAtOPPO(activity)
                || hasNotchAtVivo(activity)
                || isNotchAtAndroidP(activity);
    }

    /**
     * 小米刘海屏判断.
     */
    public static boolean isNotchAtMiui(Activity activity) {
